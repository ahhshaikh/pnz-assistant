...
const StreamlitComponent = (props) => {
  ...
  const initializeProps = async (props) => {
  ...
  // i can update it 
  const updateStateAndNotifyHost = async (msg = null, error = null) => {
  ...
  // replace this popup window i made earlier
